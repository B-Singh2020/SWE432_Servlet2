...
//Location of servlet.
static String Domain  = "https://swe432-servlet2.herokuapp.com/";
static String Path    = "";
static String Servlet = "InClassTwo";

//Button labels
static String OperationConcat1 = "Concat 1";
static String OperationConcat2 = "Concat 2";
...
if ((lhsStr != null) && (lhsStr.length() > 0))
  Left = new String(lhsStr);
if ((rhsStr != null) && (rhsStr.length() > 0))
  Right = new String(rhsStr);

if (operation.equals(OperationConcat1))
{
  result = new String(Left + Right);
}
else if (operation.equals(OperationConcat2))
{
	result = new String(Right + Left);
}
...
out.println(" <br>");
out.println(" <br>");
out.println(" <input type=\"submit\" value=\"" + OperationConcat1 + "\" name=\"Operation\">");
out.println(" <input type=\"submit\" value=\"" + OperationConcat2 + "\" name=\"Operation\">");
